  ...
  >
    ...
    >
      <div class="flex flex-col items-center">
        ...
        />
        <p class="text-md font-[900]">LIBERTAD KIDDIE CARE CENTER INC.</p>
      </div>
      <div class="mt-12 text-xl font-[900] italic">
        YOUR FUTURE STARTS HERE.
      </div>
      <div class="mt-12 flex flex-col items-center">
        <div class="border-b border-primary_dark text-lg font-semibold">
          Contact us
        </div>
        <div class="mt-6 flex flex-wrap justify-center gap-6">
            ...
            <div class="flex max-w-[300px] gap-3">
              <div class="mt-1">
                <svg
                  ...
                  class="h-[22px] w-[22px] fill-gray-400"
                  viewBox="0 0 384 512"
                >
                  <path
              ...
              <p class="text-white">
                #36 San Gregorio Ext. Kimpo Subd., Cotabato City, Philippines
              </p>
            </div>
          </div>
          ...
          <div>
            <div class="flex max-w-[300px] gap-3">
              ...
              <p class="text-white">
                Monday to Friday - 7:30 AM to 4:00 PM Saturday - 8:00 AM to
                11:30 AM
              </p>
            </div>
          </div>
          <div>
            <div class="flex max-w-[300px] gap-3">
              ...
              <div class="flex flex-col text-white">
                <p>(63) 9092-6213-21 Registrar</p>
                <p>(63) 9092-6213-21 Admin</p>
                <p>(63) 9092-6213-21 Home</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="flex gap-8">
          <div class="flex gap-4">
            <a href="">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                class="ionicon h-6 w-6 fill-white"
                viewBox="0 0 512 512"
              >
                <path
    ...
    >
      <div class="flex gap-3 font-semibold">
        ...
        <span class="w-[1.5px] bg-gray-400"></span>
        <p class="cursor-pointer" onclick="privacy_policy.showModal()">
          Privacy & Policy
        </p>
      ...
      <p class="sm:text-md mt-2 text-[8px] text-white">
        Copyright © 2023. All Rights Reserved Libertad Kiddie Care Center Inc.
        Cotabato
      </p>
    </div>
  </footer>
